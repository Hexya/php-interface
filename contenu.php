  ...
  <div class="container">
    <div class="center-content">
      ...
      //1 Connexion
       ...
       $sql= "SELECT * FROM contenus WHERE cont_categorie = ".$_GET['idcat']." ORDER BY cont_titre ASC";
       //3 Executer la requete
       $req = mysqli_query($connexion, $sql) or die(mysqli_eror($connexion));
       //4 Traitements des données
       if(mysqli_num_rows($req)===0) { //Nombre de ligne que que renvoi la requete nb id
         ...
         while ($cont = mysqli_fetch_array($req)) { //On separe les ligne
           ...
           echo "<a href='article.php?idcat=".$cont['cont_id']."'><div class='block-article'><img class='avatar-img' src='./images/imgCont/".$cont['cont_img1']."'><p> ".$cont['cont_titre']." </br><span> ".$cont['cont_ss_titre']."</span></p>
